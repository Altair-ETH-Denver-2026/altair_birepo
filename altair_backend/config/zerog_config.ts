    ...
    swaps: [
      {
        ...
        chain: '', // chain identifier for the swap execution
        sellToken: '', // token symbol sold in the swap
        buyToken: '', // token symbol bought in the swap
        sellAmount: '', // amount sold, stored as text for precision
        buyAmount: '', // amount received, stored as text for precision
